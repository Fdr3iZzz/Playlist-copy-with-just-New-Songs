declare namespace Spicetify {
	...
	class URI {
		 ...
		 */
		static fromString(str: string): Spicetify.URI;
	...
	namespace ContextMenu {
		...
		class Item {
			...
			constructor(name: string, onClick: Spicetify.ContextMenu.OnClickCallback, shouldAdd?: (uri) => boolean, icon?: string, disabled?: boolean);
			name: string;
			icon: Icon | string;
			disabled: boolean;
			/**
